  ...
  const fetchClinicData = async () => {
    try {
      ...
      if (clinicDoc.exists()) {
        ...
        // Store clinic code in localStorage if available
        if (data.clinicCode) {
          localStorage.setItem('healqr_clinic_code', data.clinicCode);
        }
          ...
          <div className="p-4 md:p-8">
            ...
            <div className="mb-6 md:mb-8">
              ...
              {clinicData?.clinicCode && (
                <div className="mb-4 p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg inline-block">
                  <div className="flex items-center gap-3">
                    <QrCode className="w-5 h-5 text-blue-500" />
                    <div>
                      <p className="text-xs text-gray-400 mb-1">Clinic Code</p>
                      <p className="text-lg font-mono font-semibold text-blue-400">{clinicData.clinicCode}</p>
                    </div>
                    <button
                      onClick={() => {
                  ...
                  <p className="text-xs text-gray-500 mt-2">Share this code with doctors to link them to your clinic</p>
                </div>
              )}
