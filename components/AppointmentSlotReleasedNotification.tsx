          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="px-6 pt-6 pb-4">
              ...
              <p className="text-gray-700 text-sm mb-4 leading-relaxed">
                Your appointment slot with {doctorName} at {clinicName} has been automatically released due to no-show.
              </p>

              {/* Appointment Details */}
              <div className="bg-gray-50 rounded-lg p-4 mb-4 space-y-2">
                <div>
                  <span className="text-gray-900">Missed Appointment:</span>{' '}
              ...
              {/* Rebook Instructions */}
              <div className="mb-4">
                <p className="text-gray-900 text-sm mb-2">To rebook:</p>
                <div className="text-gray-600 text-sm space-y-1 ml-2">
                  <p>• Scan the doctor's unique QR code</p>
              ...
              <p className="text-gray-700 text-sm mb-4 text-center italic">
                We understand emergencies happen. Please reschedule at your earliest convenience.
              </p>
