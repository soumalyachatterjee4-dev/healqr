  ...
  const handleFinalSubmit = async (shareViaWhatsapp: boolean = false) => {
    ...
    try {
      ...
      const addFooter = (pDoc: any) => {
        ...
        const renderDisclaimer = (d: any, yPos: number) => {
          ...
          d.setDrawColor(180, 160, 130);
          d.setLineWidth(0.3);
          d.setFillColor(255, 250, 235);
          const dH = 8;
          d.roundedRect(fMargin, yPos, fContentW, dH, 1.5, 1.5, 'FD');
          d.setFont('helvetica', 'bold');
          d.setFontSize(5);
          d.setTextColor(120, 100, 70);
          d.text(line1, pWidth / 2, yPos + 3, { align: 'center' });
          d.setFont('helvetica', 'normal');
          d.setFontSize(5);
          d.setTextColor(130, 110, 80);
          d.text(line2, pWidth / 2, yPos + 6, { align: 'center' });
          return dH + 1;
        };
        ...
        if (isClinic && doctorInfo.allDoctors && doctorInfo.allDoctors.length > 0) {
          ...
          afterBox += renderDisclaimer(pDoc, afterBox);
          ...
          renderDisclaimer(pDoc, pHeight - 12);
          ...
          pDoc.text(
            ...
            pWidth / 2, pHeight - 26, { align: 'center' }
          );

          renderDisclaimer(pDoc, pHeight - 15);
          ...
          pDoc.text(
            'POWERED BY WWW.HEALQR.COM  \u2022  GENERATED BY GEMINI FLASH 1.5',
            pWidth / 2, pHeight - 7, { align: 'center' }
          );
        }
      };
