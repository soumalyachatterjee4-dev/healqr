...
interface ClinicCMEViewerProps {
  onBack: () => void;
  companyName: string;
  clinicName: string;
}

export default function ClinicCMEViewer({ onBack, companyName, clinicName }: ClinicCMEViewerProps) {
  ...
  const loadCMEContent = async () => {
    ...
    try {
      ...
      // Check if CME is enabled for this clinic
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-400 max-w-md">
            {!companyName
              ...
              : 'The pharma company has not enabled CME content access for your clinic.'}
          </p>
